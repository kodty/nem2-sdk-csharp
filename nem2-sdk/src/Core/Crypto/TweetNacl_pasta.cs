...
namespace TweetNaclSharp.Core
{
    ...
    {
        public NaclException() : base()
        { }

        public NaclException(string message) : base(message)
        { }
    }
}
...
namespace TweetNaclSharp
{
    public class NaclFast
    {
        ...
        internal static void Pack(byte[] r, long[][] p)
        {
        ...
        internal static void Scalarmult(long[][] p, long[][] q, byte[] s)
        {
            Set25519(p[0], gf0);
            Set25519(p[1], gf1);
            Set25519(p[2], gf1);
        ...
        internal static int Unpackneg(long[][] r, byte[] p)
        {
