...
namespace Integration_Tests
{
    internal class MetadataRequests
    {
        ...
        {
            var client = new MetadataHttp("75.119.150.108", 3000);
            ...
            Assert.That(response[0].Id, Is.EqualTo("6644F471079630C933A7A6E0"));
        ...
        public async Task GetMetadataMerkle()
        {
            ...
            Assert.That(response.Tree[0].BranchHash, Is.EqualTo("2817B2922712AFC068EEE302F3AE3406CF8BA12F53DBAA84F35650A768496424"));
        }
    }
}
