...
namespace Integration_Tests
{
    internal class NamespaceRequests
    {
        ...
        public async Task SearchNamespaces()
        {
            ...
            Assert.That(response.Data[0].Id, Is.EqualTo("6644D77FED4FBE21460A2240"));
            Assert.That(response.Data[0].Namespace.RegistrationType, Is.EqualTo(0));
            Assert.That(response.Data[0].Namespace.Alias.Type, Is.EqualTo(0));
        }
