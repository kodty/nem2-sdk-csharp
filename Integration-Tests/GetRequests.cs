...
namespace Integration_Tests
{
    public class AccountRequests
    {
        ...
        public async Task GetAccountRestrictionMerkle()
        {
            ...
            Assert.That(response.Tree[0].Links[0].Link, Is.EqualTo("DC9DCABBE879ADE931061831FB24B8BF1DA5D8B672BAA0E6A3E5E6B57CABAFFF"));
            ...
            Assert.That(response.Tree[0].BranchHash, Is.EqualTo("3CC1BB0F05060BE93AF85A63A3720EA1D6E4B0E4A8849D1834D31ED758A09487"));
        }
    }
}
