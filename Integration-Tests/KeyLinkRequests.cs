...
namespace Integration_Tests
{
    public class KeyLinkRequests
    {
        ...
        {
            var txClient = new TransactionHttp("75.119.150.108", 3000);
            ...
            var response = await txClient.SearchConfirmedTransactions(qModel);
        ...
        public async Task GetVotingKeyLinkTransaction()
        {
            ...
            var response = await txClient.GetConfirmedTransaction("901807C96B582AACC140BE64CE3C18AF754E3DFBD2269AC573A5121097005DF8");
        ...
        public async Task GetNodeKeyLinkTransaction()
        {
            ...
            var response = await txClient.GetConfirmedTransaction("F6A12DDA59412CF3A74D558E631FF6C6F5E2B43620CDC950698BBD17FF8F0B57");
        ...
        public async Task GetAccountKeyLinkTransaction()
        {
            ...
            var response = await txClient.GetConfirmedTransaction("5C27AD1B777E811946DDB9AB5ABCC464C7B80CCE77CDA3870EB19F1DD1AF22BA");
