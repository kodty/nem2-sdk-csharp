...
namespace io.nem2.sdk.src.Infrastructure.Buffers.FlatBuffers
{
    /// <summary>
    ...
    internal class FlatBufferBuilder
    {
        ...
        /// </param>
        internal FlatBufferBuilder(int initialSize)
        {
            if (initialSize <= 0)
        ...
        /// </summary>
        internal bool ForceDefaults { get; set; }

        /// @cond FLATBUFFERS_INTERNAL

        internal int Offset => _bb.Length - _space;

        internal void Pad(int size)
        {
        ...
        internal void Prep(int size, int additionalBytes)
        {
        ...
        internal void AddOffset(int off)
        {
        ...
        /// </summary>
        internal VectorOffset EndVector()
        {
        ...
        internal VectorOffset CreateVectorOfTables<T>(Offset<T>[] offsets) where T : struct
        {
            NotNested();
        ...
        internal void StartObject(int numfields)
        {
            if (numfields < 0)
        ...
        // buffer.
        internal void Slot(int voffset)
        {
        ...
        internal void AddBool(int o, bool x, bool d) { if (ForceDefaults || x != d) { AddBool(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddSbyte(int o, sbyte x, sbyte d) { if (ForceDefaults || x != d) { AddSbyte(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddByte(int o, byte x, byte d) { if (ForceDefaults || x != d) { AddByte(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddShort(int o, short x, int d) { if (ForceDefaults || x != d) { AddShort(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddUshort(int o, ushort x, ushort d) { if (ForceDefaults || x != d) { AddUshort(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddInt(int o, int x, int d) { if (ForceDefaults || x != d) { AddInt(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddUint(int o, uint x, uint d) { if (ForceDefaults || x != d) { AddUint(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddLong(int o, long x, long d) { if (ForceDefaults || x != d) { AddLong(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddUlong(int o, ulong x, ulong d) { if (ForceDefaults || x != d) { AddUlong(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddFloat(int o, float x, double d) { if (ForceDefaults || x != d) { AddFloat(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddDouble(int o, double x, double d) { if (ForceDefaults || x != d) { AddDouble(x); Slot(o); } }
        ...
        /// and <see cref="ForceDefaults"/> is false, the value will be skipped.</param>
        /// <param name="d">The default value to compare the value against</param>
        internal void AddOffset(int o, int x, int d) { if (ForceDefaults || x != d) { AddOffset(x); Slot(o); } }
        /// @endcond
        ...
        /// </returns>
        internal StringOffset CreateString(string s)
        {
            NotNested();
            AddByte(0);
        ...
        // `d` is always 0.
        internal void AddStruct(int voffset, int x, int d)
        {
            if (x != d)
            {
                Nested(x);
        ...
        internal void Required(int table, int field)
        {
        ...
        /// </param>
        internal void Finish(int rootTable)
        {
        ...
        /// </returns>
        internal ByteBuffer DataBuffer => _bb;
        ...
        /// `root_table`.
        /// </param>
        internal void Finish(int rootTable, string fileIdentifier)
        {
            Prep(_minAlign, sizeof(int) +
