...
{
    internal struct MosaicSupplyChangeTransactionBuffer : IFlatbufferObject
{
  private Table __p;
  ...
  public static MosaicSupplyChangeTransactionBuffer GetRootAsMosaicSupplyChangeTransactionBuffer(ByteBuffer _bb, MosaicSupplyChangeTransactionBuffer obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public byte Direction { get { int o = __p.__offset(20); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  public uint Delta(int j) { int o = __p.__offset(22); return o != 0 ? __p.bb.GetUint(__p.__vector(o) + j * 4) : (uint)0; }
  public int DeltaLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
  public ArraySegment<byte>? GetDeltaBytes() { return __p.__vector_as_arraysegment(22); }
  ...
  public static void AddDelta(FlatBufferBuilder builder, VectorOffset deltaOffset) { builder.AddOffset(9, deltaOffset.Value, 0); }
  public static VectorOffset CreateDeltaVector(FlatBufferBuilder builder, uint[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddUint(data[i]); return builder.EndVector(); }
  public static void StartDeltaVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<MosaicSupplyChangeTransactionBuffer> EndMosaicSupplyChangeTransactionBuffer(FlatBufferBuilder builder) {
    int o = builder.EndObject();
    return new Offset<MosaicSupplyChangeTransactionBuffer>(o);
  }
  public static void FinishMosaicSupplyChangeTransactionBufferBuffer(FlatBufferBuilder builder, Offset<MosaicSupplyChangeTransactionBuffer> offset) { builder.Finish(offset.Value); }
};
