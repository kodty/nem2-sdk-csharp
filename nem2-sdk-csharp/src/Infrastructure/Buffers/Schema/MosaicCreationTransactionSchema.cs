...
{
    internal class MosaicCreationTransactionSchema : SchemaHelpers.Schema
    {
        internal MosaicCreationTransactionSchema() : base( 
            new List<SchemaAttribute> { 
                ...
                new ArrayAttribute("parentId", Constants.Value.SIZEOF_INT),
                new ArrayAttribute("mosaicId", Constants.Value.SIZEOF_INT),
                new ScalarAttribute("mosaicNameLength", Constants.Value.SIZEOF_BYTE),
                ...
                new ArrayAttribute("mosaicName", Constants.Value.SIZEOF_BYTE),
