...
{
    internal class HashLockTransactionSchema : SchemaHelpers.Schema
    {
        internal HashLockTransactionSchema() : base(
            new List<SchemaAttribute> {
                ...
                new ArrayAttribute("hash", Constants.Value.SIZEOF_BYTE)
            })
        { }
    }
}
